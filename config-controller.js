    ...
    constructor(options = {}) {
        ...
        this.languages = {
            fr: {
                ...
                rules_3: "La zone dorée s'élargit à mesure que les étapes s'allongent : trois semaines demandent le centre exact, une année tolère la dérive.",
                rules_4: "Chaque carte donne et chaque carte prend. Choisissez celle dont le sacrifice vous coûte le moins.",
                turn: "Tour",
                score: "Score",
                best: "Best:",
                total_balance: "Équilibre Total",
                objectif: "Objectif",
                duree_3_semaines: "trois semaines",
                duree_6_semaines: "six semaines",
                duree_3_mois: "trois mois",
                duree_6_mois: "six mois",
                duree_1_an: "une année entière",
                duree_generique: "un moment",
                parcours_bravo: "Bravo. Tu as maintenu ton équilibre {tenu}.",
                parcours_defi: "Voyons voir si tu peux le tenir {suite}.",
                parcours_echec: "Ton équilibre n'était pas trouvé au terme de l'étape.",
                parcours_reprise: "Rien n'est perdu : tu reprends là où tu en étais.",
                parcours_sommet: "Une année entière. Tu as trouvé le Grand Équilibre. Une nouvelle vie commence.",
                semaine: "Semaine",
                equilibre_cible: "Équilibre",
                votre_parcours: "VOTRE PARCOURS",
                objectif_etape: "Tenir {suite}",
                legacy: "Héritage",
                harmony: "HARMONIE",
                ...
                card_reading: "Lecture vocale des cartes",
                victoire_titre: "L'Équilibre Atteint",
                victoire_desc: "Vous avez tenu l'harmonie. Ni manque, ni excès.",
                victoire_rang: "Titre gagné : {titre}",
                banniere_victoire: "UNE ÉTAPE FRANCHIE",
                victoire_rang_defaut: "Éveillé",
                banniere_defaite: "L'EXPÉRIENCE S'ACHÈVE",
                harmonie_serie: "HARMONIE",
                conseil: "CONSEIL",
                harmonie_bonus: "score × 2,5",
                conseil_reglage: "Carte conseillée",
                avert_zone: "sortira de la zone sûre",
                avert_mortel: "cette carte met fin à la partie",
                filet_titre: "LE DESTIN VOUS ÉPARGNE",
                filet_exces: "a débordé. L'excès tue autant que le manque. Ce pilier revient au centre — mais la prochaine fois sera la bonne.",
                filet_manque: "s'est épuisé. Un pilier abandonné vous condamne. Il revient au centre — mais la prochaine fois sera la bonne.",
                rules_victoire: "POUR GAGNER : terminez l'étape avec vos 4 piliers dans la zone dorée.",
                objectif_gagner: "OBJECTIF",
                zone_sure: "ZONE SÛRE 40-85",
                voice_on: "Lecture vocale : activée",
                voice_off: "Lecture vocale : coupée",
                ...
                voice_plus: "plus",
                voice_intro: "Ton choix impactera",
                voice_de: "de",
                voice_poss_spirituality: "ta",
                voice_poss_love: "ton",
                voice_poss_health: "ta",
                voice_poss_money: "ton",
                voice_moins: "moins",
                ...
                tuto_1: "Quatre piliers soutiennent votre existence : Spiritualité, Amour, Santé et Argent. Si l'un tombe à zéro ou atteint cent, tout s'arrête.",
                tuto_2: "Chaque tour, trois cartes vous sont proposées. Chacune donne et chacune prend. Il n'existe aucune carte parfaite.",
                tuto_3: "POUR GAGNER : amenez vos quatre piliers dans la zone dorée, marquée sur chaque jauge, et tenez-les-y jusqu'à la fin de l'étape. Le compteur ÉQUILIBRE en haut vous dit combien y sont déjà.",
                tuto_4: "On ne vous jugera pas sur votre plus haut pilier, mais sur le plus bas. L'équilibre vaut mieux que l'excès.",
                peril_low: "en péril",
            ...
            en: {
                ...
                objectif: "Goal",
                duree_3_semaines: "three weeks",
                duree_6_semaines: "six weeks",
                duree_3_mois: "three months",
                duree_6_mois: "six months",
                duree_1_an: "a whole year",
                duree_generique: "a while",
                parcours_bravo: "Well done. You held your balance for {tenu}.",
                parcours_defi: "Let us see if you can hold it {suite}.",
                parcours_echec: "Your balance was not found by the end of the stage.",
                parcours_reprise: "Nothing is lost: you resume where you left off.",
                parcours_sommet: "A whole year. You have found the Great Balance. A new life begins.",
                semaine: "Week",
                equilibre_cible: "Balance",
                votre_parcours: "YOUR JOURNEY",
                objectif_etape: "Hold {suite}",
                legacy: "Legacy",
                harmony: "HARMONY",
                ...
                card_reading: "Spoken card reading",
                victoire_titre: "Balance Attained",
                victoire_desc: "You held the harmony. Neither lack, nor excess.",
                victoire_rang: "Title earned: {titre}",
                banniere_victoire: "A STAGE COMPLETED",
                victoire_rang_defaut: "Awakened",
                banniere_defaite: "THE EXPERIENCE ENDS",
                harmonie_serie: "HARMONY",
                conseil: "ADVICE",
                harmonie_bonus: "score × 2.5",
                conseil_reglage: "Suggested card",
                avert_zone: "will leave the safe zone",
                avert_mortel: "this card ends the game",
                filet_titre: "FATE SPARES YOU",
                filet_exces: "overflowed. Excess kills as surely as lack. This pillar returns to the centre — but next time will count.",
                filet_manque: "ran dry. An abandoned pillar dooms you. It returns to the centre — but next time will count.",
                rules_victoire: "TO WIN: end the stage with all 4 pillars inside the golden band.",
                objectif_gagner: "GOAL",
                zone_sure: "SAFE ZONE 40-85",
                ...
                voice_plus: "plus",
                voice_intro: "Your choice will affect",
                voice_de: "by",
                voice_poss_spirituality: "your",
                voice_poss_love: "your",
                voice_poss_health: "your",
                voice_poss_money: "your",
                voice_moins: "minus",
                ...
                tuto_1: "Four pillars hold up your life: Spirituality, Love, Health and Money. If one falls to zero or reaches one hundred, everything stops.",
                tuto_2: "Each turn, three cards are offered. Every one gives and every one takes. No card is ever perfect.",
                tuto_3: "TO WIN: bring all four pillars into the golden band marked on each gauge, and hold them there until the stage ends. The BALANCE counter at the top shows how many are already in.",
                tuto_4: "You will not be judged on your highest pillar, but on your lowest. Balance is worth more than excess.",
                peril_low: "in peril",
        ...
        this.currentConfig = {
            ...
            cardReading: true,
            // null = automatique : conseil pendant les six premieres parties
            conseil: null
        };
    }
